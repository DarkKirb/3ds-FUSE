...
class RomFSBase(LoggingMixIn, Operations):
    def traverse(self):
    ...
    def __init__(self,f,mount, noivfc=False):
        def align(a,b):
            if a%b:
                return a-(a%b)+b
            return a
        ...
        if not noivfc:
            ...
            if self.header[:4] == b"IVFC":
                raise ValueError("This is not a ROMfs!")
        ...
        print("Reading the directory tree. This can take a while…")
